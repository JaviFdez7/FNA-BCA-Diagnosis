...
- El Silhouette Score sin reducción es 0.54, lo que indica una calidad moderada de los clusters. Esto sugiere que los puntos dentro de los clusters son razonablemente similares entre sí y están razonablemente separados de los puntos de otros clusters.
Este valor sugiere que el clustering hecho en el espacio original de las variables es adecuado, pero podría mejorar.
- El Silhouette Score después de realizar PCA es 0.34, lo cual es más bajo que el obtenido sin reducción de dimensionalidad. Esto indica que, al reducir las dimensiones a través de PCA, la calidad del clustering empeoró ligeramente.
-El Silhouette Score después de realizar t-SNE es 0.43, que es más bajo que el valor sin reducción pero superior al de PCA. Aunque t-SNE está diseñado principalmente para la visualización de datos, no optimiza el agrupamiento como tal, lo que puede haber causado que los resultados del clustering fueran menos eficientes.
