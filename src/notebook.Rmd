...
# Calcular las métricas para la clase mayoritaria
...
# La probabilidad de la clase "B" (mayoritaria) es constante y es igual a su frecuencia relativa
...
El resultado más preocupante es la incapacidad del modelo para identificar correctamente los casos malignos. Esto se evidencia por un *Valor Predictivo Positivo (PPV)* de 62.74%, pero un *Valor Predictivo Negativo (NPV)* indefinido (NaN), ya que nunca predice la clase M. Además, el área bajo la curva ROC (AUC-ROC) es de 0.5, lo que indica que el modelo no es capaz de discriminar entre las dos clases.
